...
history=model.fit(x_train,y_true, batch_size=60, epochs=3, validation_data=(x_val,y_val),verbose=1)
...
import pickle
with open('C:/Users/adrin/Desktop/isa/Yolo_isa-master/Yolo_isa-master/y_pred_VOC2.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
