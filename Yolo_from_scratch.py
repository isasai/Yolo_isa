...
#Model and weights
model_name="simple_40_10.h5"
model.save("C:/Users/adrin/Desktop/isa/Yolo_isa-master/Yolo_isa-master/models/complete/" + model_name)
...
config_simple_40_30 = model.to_json()
config_name="config_simple_40_30"
with open("C:/Users/adrin/Desktop/isa/Yolo_isa-master/Yolo_isa-master/models/net/" + config_name, 'w+') as f:
    json.dump(config_simple_40_30, f)
reinitialized_model = keras.models.model_from_json(config_simple_40_30)

#Weights
weights = model.get_weights()
model.set_weights(weights) 

weights_name="w_simple_40_10.h5"
model.save_weights("C:/Users/adrin/Desktop/isa/Yolo_isa-master/Yolo_isa-master/models/weights/" + weights_name)
